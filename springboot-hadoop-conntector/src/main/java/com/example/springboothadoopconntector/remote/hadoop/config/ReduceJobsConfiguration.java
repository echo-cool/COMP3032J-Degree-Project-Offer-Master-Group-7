...
import com.example.springboothadoopconntector.SpringbootHadoopConntectorApplication;
import com.example.springboothadoopconntector.remote.hadoop.mapReduce.WordReduce;
import com.example.springboothadoopconntector.remote.hadoop.mapper.WordMapper;
...
//        System.out.println(job);
        ...
        job.setJarByClass(SpringbootHadoopConntectorApplication.class);
        String projectDir = System.getProperty("user.dir");
        if(Objects.equals(projectDir, "/")){
            projectDir = "";
        }
        String resourceLocation = projectDir + File.separatorChar + "out" + File.separatorChar + "artifacts" + File.separatorChar
                + "hadoop_app" + File.separatorChar;
        job.setJar(resourceLocation + "hadoop_app.jar");
        job.setReducerClass(WordReduce.class);
        job.addFileToClassPath(new Path("/user/hadoop/libs/IKAnalyzer2012_u6.jar"));
