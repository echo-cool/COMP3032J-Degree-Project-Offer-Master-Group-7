...
//                    .data("0-averageMetric", sumMetric)
                    ...
                    .data("AverageGPA", sumMetric[0])
                    .data("AverageGRE_Overall", sumMetric[1])
                    .data("AverageGRE_Verbal", sumMetric[2])
                    .data("AverageGRE_Quantitative", sumMetric[3])
                    .data("AverageGRE_Writing", sumMetric[4])
                    .data("AverageIELTS_Listening", sumMetric[5])
                    .data("AverageIELTS_Reading", sumMetric[6])
                    .data("AverageIELTS_Writing", sumMetric[7])
                    .data("AverageIELTS_Speaking", sumMetric[8])
                    .data("AverageIELTS_Overall", sumMetric[9])
                    .data("AverageRanking", sumMetric[10])
                    ;
        }
        return R.error();
    }
