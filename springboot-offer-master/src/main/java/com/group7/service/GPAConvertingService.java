...
public interface GPAConvertingService {
    ...
    void convertGPA(MultipartFile file, EGPAScale originalScale, UserRepository userRepository, ProfileRepository profileRepository, GradeRepository gradeRepository, User user) throws Group7Exception;
}
